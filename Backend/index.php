<!-- ORIGINAL
https://github.com/BootstrapDash/Regal-Free-Bootstrap-Admin-Template
https://www.bootstrapdash.com/product/regal -->
<!DOCTYPE html>
<html lang="en">
...
<body>
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center" style="background: rgb(22,30,84);">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown d-lg-flex d-none">
            <button type="button" class="btn btn-info font-weight-bold border-0" style="background: rgb(255,142,75);">+ Create New</button>
          </li>
