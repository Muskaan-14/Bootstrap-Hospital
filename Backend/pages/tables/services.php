    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background: white; color: black;">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="services.php" style="background: rgb(255,142,75);">
              <i class="icon-square-check menu-icon text-white"></i>
              <span class="menu-title text-white" style="color: rgb(22,30,84);">Services</span>
            </a>
          </li>
          <li class="nav-item">
