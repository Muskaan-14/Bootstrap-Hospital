    ...
    <div class="container pt-5">
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <h1 class="text-center text-lg-start fw-bold myhead1" style="color: rgb(22,30,84); font-size: 40px;">
            Testimonials</h1>
          <h6 class="text-center text-lg-start mt-4" style="color: rgb(255,142,75);">Home
            <span class="text-center text-lg-start text-secondary"> / Testimonials</span>
          </h6>
        </div>
        <div class="col-lg-6 pt-5 pt-lg-0">
          <img class="img-fluid" src="Testimonials.png" alt="">
        </div>
      </div>
    </div>
  </main>
      ...
      <div class="mt-5 owl-carousel owl-theme">
        ...
        <!-- <div class="item">
          <div class="row mx-xl-5 px-xl-5">
            ...
            <div class="col-sm-8 align-self-center">
              <h3 class="pt-4 pb-2 fw-bold " style="color: rgb(22,30,84);">Rossy</h3>
              <p class="text-secondary ">
                The services are very good. I recommend another patient to come to this hospital.
                Everything in
                hospital is good.
              </p>
            </div>
