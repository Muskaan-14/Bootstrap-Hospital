...
<head>
    ...
    <title>Privacy Policy | HMS</title>
</head>
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-xl-0">
                        ...
                        <li class="nav-item dropdown p-xl-2 position-relative">
                            ...
                            <ul class="pe-5 dropdown-menu ms-xl-2 ms-0 border-0 pt-1 rounded-3 position-absolute"
                                ...
                                <li>
                                    <a class="nav-link active bg-white dropdown-item text-secondary mx-4 py-2" aria-current="page"
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <h1 class="text-center text-lg-start fw-bold myhead1"
                        style="color: rgb(22,30,84); font-size: 40px;">Privacy Policy</h1>
                    <h6 class="text-center text-lg-start mt-4" style="color: rgb(255,142,75);">Home
                        <span class="text-center text-lg-start text-secondary"> / Privacy Policy</span>
                    </h6>
                </div>
                <div class="col-lg-6 pt-5 pt-lg-0">
                    <img class="img-fluid" src="privacy-policy.png" alt="">
                </div>
            </div>
        </div>
    </main>

    <section class="py-xl-5 my-xl-5">
        <div class="container py-5 my-5">
            <ol>
                <li>
                    Patient Rights and Responsibilities: Patients have the right to receive respectful and considerate
                    care, to be informed of their medical condition and treatment options, and to participate in
                    decisions about their care. Patients are responsible for providing accurate and complete information
                    about their health history and insurance coverage, and for following the treatment plan recommended
                    by their healthcare provider.
                </li>
                <li>
                    Medical Record Privacy: The hospital will keep patient medical records confidential and will only
                    release them with the patient's written consent or as required by law.
                </li>
                <li>
                    Cancellation Policy: Patients are required to provide at least 24 hours notice if they need to
                    cancel or reschedule an appointment.
                </li>
                <li>
                    No Show Policy: Patients who do not show up for scheduled appointments will be charged a fee.
                </li>
                <li>
                    Complaint and Grievance Policy: Patients have the right to file a complaint or grievance about their
                    care or treatment. The hospital will investigate and respond to all complaints in a timely manner.
