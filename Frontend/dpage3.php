                ...
                <div class="row mt-5 gx-5 gy-5 justify-content-center">
                    <div class="col-md-6 col-lg-4 col-xxl-3">
                        <div class="position-relative pb-5 justify-content-center d-flex">
                            <img src="doctor6.jpeg" class="p-2 img-fluid rounded-circle"
                ...
                <nav class="my-5" aria-label="Page navigation example">
                    <ul class="justify-content-center pagination">
                        <li class="page-item m-1">
                            <a class="page-link text-dark border-0 rounded-3 shadow-none" href="dpage2.php" aria-label="Previous">
                        ...
                        <li class="page-item active m-1" aria-current="page">
                            <a class="page-link text-dark border-0 rounded-3 shadow-none" href="#">3</a>
                        </li>
                        <li class="page-item disabled m-1">
                            <a class="page-link text-dark border-0 rounded-3 shadow-none" href="#" aria-label="Next">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-md-6 col-lg-2">
                    ...
                    <ul class="list-unstyled">
                        <li class="py-2">
                            <a class="text-decoration-none text-white" style="color: rgb(255,142,75);" href="index.php">Home</a>
                        </li>
                        <li class="py-2">
