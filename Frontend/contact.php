...
<body>
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <h1 class="text-center text-lg-start fw-bold myhead1"
                        style="color: rgb(22,30,84); font-size: 40px;">Contact</h1>
                    <h6 class="text-center text-lg-start mt-4" style="color: rgb(255,142,75);">Home
                        <span class="text-center text-lg-start text-secondary"> / Contact</span>
                    </h6>
                </div>
                <div class="col-lg-6 pt-5 pt-lg-0">
                    <img class="img-fluid" src="Contact.png" alt="">
                </div>
            </div>
        </div>
    </main>
        ...
        <div class="container text-center my-5 pb-5">
            <div class="row gx-5 gy-5">
                <div class="col-md-6 col-xxl-3 d-flex">
                    <div class="w-100 border px-3" style="border-radius: 20px;">
                        ...
                        <p class="py-2 text-secondary">Call Today</p>
                    </div>
                </div>
                <div class="col-md-6 col-xxl-3 d-flex">
                    <div class="w-100 border px-3" style="border-radius: 20px;">
                ...
                <div class="col-md-6 col-xxl-3 d-flex">
                    <div class="w-100 border px-3" style="border-radius: 20px;">
                        <i class="fa-solid fa-clock p-4 fs-3 rounded-circle"
                            style="color: rgb(22,30,84); background-color: rgb(232,241,254); margin-top: -30px;">
                        </i>
                        <h5 class="pt-4" style="color: rgb(22,30,84);">08:00 AM to 21:00 PM</h5>
                        <p class="py-2 text-secondary">Open Hours</p>
                    </div>
                </div>
                <div class="col-md-6 col-xxl-3 d-flex">
                    <div class="w-100 border px-3" style="border-radius: 20px;">
                        <i class="fa-solid fa-location-dot p-4 fs-3 rounded-circle"
                            style="color: rgb(249,99,118);  background-color: rgb(254,239,241); margin-top: -30px;">
                        </i>
                        <h5 class="pt-4" style="color: rgb(22,30,84);">C/303, Atlanta Shopping Mall Sudama Chowk, Mota
                            Varachha,
                            Surat,
                            Gujarat 394101</h5>
                        <p class="py-2 text-secondary">Our Location</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container mycontactbg px-5 mx-5">
            <form action="" class="p-5">
                <div class="row bg-white px-5 pt-4 shadow" style="border-radius: 20px; margin-bottom: -100px">
                    <input class="w-100 p-3 border rounded-3 my-3" type="name" name="name"
                        placeholder="Enter your name">
                    <input class="w-100 p-3 border rounded-3 my-3" type="email" name="email"
                        placeholder="Enter your email">
                    <input class="border w-100 rounded-3 my-3" type="tel" id="phone" maxlength="10" minlength="10"
                        name="contact" placeholder="Contact No" required>
                    <select class="w-100 p-3 border rounded-3 my-3" name="inquiry" id="">
                        <option value="">General Inquiry</option>
                        <option value="">Feedback/Suggestions</option>
                    </select>
                    <textarea class="w-100 p-3 border rounded-3 my-3" name="msg" id="" cols="30" rows="1"
                        placeholder="Type your message" required></textarea>
                    <div class="text-center py-4">
                        <button class="btn p-3 py-2 text-white" style="background: rgb(255,142,75);">Send
                            Message</button>
                    </div>
                </div>
            </form>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-md-6 col-lg-2">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="py-2">
                            <a class="text-decoration-none" style="color: rgb(255,142,75);"
