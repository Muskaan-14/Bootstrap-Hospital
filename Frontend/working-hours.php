...
<body>
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <h1 class="text-center text-lg-start fw-bold myhead1"
                        style="color: rgb(22,30,84); font-size: 40px;">Working Hours</h1>
                    <h6 class="text-center text-lg-start mt-4" style="color: rgb(255,142,75);">Home
                        <span class="text-center text-lg-start text-secondary"> / Working Hours</span>
                    </h6>
                </div>
                <div class="col-lg-6 pt-5 pt-lg-0">
                    <img class="img-fluid" src="working-hours.png" alt="">
                </div>
            </div>
        </div>
    </main>
        ...
        <div class="container my-5">
            <div class="bg-white p-4 m-2 row shadow" style="border-radius: 20px;">
                ...
                <div class="col-md-6 col-lg-3 col-12">
                    <div class="p-3 m-3 border rounded-3">
                        <select class="w-100 border-0" name="Doctors">
                            <option value="">Steven Lyon</option>
                            <option value="">Steven Lyon</option>
                            <option value="">Steven Lyon</option>
                            <option value="">Steven Lyon</option>
                            <option value="">Steven Lyon</option>
                ...
                <div class="col-md-6 col-12 col-lg-3">
                    <div class="rounded-3 p-3 m-3 border">
                        <input class="w-100 border-0 outline-0" type="date">
                    </div>
                </div>
                <div class="col-12 col-lg-3">
                    <a class="row justify-content-center m-3 p-3 rounded-3 text-white text-decoration-none" href="#"
    ...
    <section class="bg-light">
        <div class="container py-5 text-center">
            <h1 style="color: rgb(22,30,84); font-weight: 800;">Opening Hours</h1>
            <div class="mt-5">
                <div class="bg-white my-3 col-lg-6 mx-auto d-flex p-3 rounded-3">
                    <h5 style="color: rgb(22,30,84);">Monday : </h5>
                    <h5 class="ms-auto text-secondary">06:00 - 20:00</h5>
                </div>
                <div class="bg-white my-3 col-lg-6 mx-auto d-flex p-3 rounded-3">
                    <h5 style="color: rgb(22,30,84);">Tuesday : </h5>
                    <h5 class="ms-auto text-secondary">06:00 - 20:00</h5>
                </div>
                <div class="bg-white my-3 col-lg-6 mx-auto d-flex p-3 rounded-3">
                    <h5 style="color: rgb(22,30,84);">Wednesday : </h5>
                    <h5 class="ms-auto text-secondary">06:00 - 20:00</h5>
                </div>
                <div class="bg-white my-3 col-lg-6 mx-auto d-flex p-3 rounded-3">
                    <h5 style="color: rgb(22,30,84);">Thursday : </h5>
                    <h5 class="ms-auto text-secondary">06:00 - 20:00</h5>
                </div>
                <div class="bg-white my-3 col-lg-6 mx-auto d-flex p-3 rounded-3">
                    <h5 style="color: rgb(22,30,84);">Friday : </h5>
                    <h5 class="ms-auto text-secondary">06:00 - 20:00</h5>
                </div>
                <div class="bg-white my-3 col-lg-6 mx-auto d-flex p-3 rounded-3">
                    <h5 style="color: rgb(22,30,84);">Saturday : </h5>
                    <h5 class="ms-auto text-secondary">06:00 - 20:00</h5>
                </div>
                <div class="bg-white my-3 col-lg-6 mx-auto d-flex p-3 rounded-3">
                    <h5 style="color: rgb(22,30,84);">Sunday : </h5>
                    <h5 class="ms-auto text-secondary">06:00 - 20:00</h5>
                </div>
            </div>
        </div>
