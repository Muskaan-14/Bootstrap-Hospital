      ...
      <nav class="navbar navbar-expand-xl navbar-light">
        ...
        <div class="collapse navbar-collapse p-4 pt-1 p-xl-0 shadow" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-xl-0">
            ...
            <li class="nav-item p-xl-2">
              <a class="nav-link active text-secondary" aria-current="page" href="doctors.php">Doctors</a>
            </li>
            <li class="nav-item p-xl-2">
    ...
    <div class="container pt-5" style="overflow: hidden;">
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <h1 class="text-center text-lg-start fw-bold myhead1" style="color: rgb(22,30,84); font-size: 40px;">Doctors
          </h1>
    ...
    <div class="container mt-xl-5 p-xl-4">
      <div class="py-5">
        ...
        <div class="row mt-5 gx-5 gy-5 justify-content-center">
          ...
          <div class="col-md-6 col-lg-4 col-xxl-3">
            <div class="position-relative pb-5 justify-content-center d-flex">
              <img src="PJ.svg" class="p-2 img-fluid rounded-circle"
                style="height: 300px; width: 300px; object-fit: cover;">
              <div class="position-absolute bottom-0 border bg-white w-100 text-center" style="border-radius: 15px;">
                <h5 class="fw-bold" style="color: rgb(22,30,84);">Steven Lyon</h5>
                <h6 class="py-1 text-secondary">(MBBS)</h6>
          ...
          <div class="col-md-6 col-lg-4 col-xxl-3">
            <div class="position-relative pb-5 justify-content-center d-flex">
              <img src="AN.svg" class="p-2 img-fluid rounded-circle"
                style="height: 300px; width: 300px; object-fit: cover;">
              <div class="position-absolute bottom-0 border bg-white w-100 text-center" style="border-radius: 15px;">
                <h5 class="fw-bold" style="color: rgb(22,30,84);">Steven Lyon</h5>
                <h6 class="py-1 text-secondary">(MBBS)</h6>
          ...
          <div class="col-md-6 col-lg-4 col-xxl-3">
            <div class="position-relative pb-5 justify-content-center d-flex">
              <img src="TF.svg" class="p-2 img-fluid rounded-circle"
                style="height: 300px; width: 300px; object-fit: cover;">
              <div class="position-absolute bottom-0 border bg-white w-100 text-center" style="border-radius: 15px;">
                <h5 class="fw-bold" style="color: rgb(22,30,84);">Steven Lyon</h5>
                <h6 class="py-1 text-secondary">(MBBS)</h6>
          ...
          <div class="col-md-6 col-lg-4 col-xxl-3">
            <div class="position-relative pb-5 justify-content-center d-flex">
              <img src="AG.svg" class="p-2 img-fluid rounded-circle"
                style="height: 300px; width: 300px; object-fit: cover;">
              <div class="position-absolute bottom-0 border bg-white w-100 text-center" style="border-radius: 15px;">
                <h5 class="fw-bold" style="color: rgb(22,30,84);">Steven Lyon</h5>
                <h6 class="py-1 text-secondary">(MBBS)</h6>
        ...
        <nav class="my-5" aria-label="Page navigation example">
          <ul class="justify-content-center pagination">
            <li class="page-item disabled m-1">
              <a class="page-link text-dark border-0 rounded-3 shadow-none" href="#" aria-label="Previous">
                <i class="fa-solid fa-angle-left"></i>
              </a>
            </li>
            <li class="page-item active m-1" aria-current="page">
              <a class="page-link text-dark border-0 rounded-3 shadow-none" href="#">1</a>
            </li>
            <li class="page-item m-1">
              <a class="page-link text-dark border-0 rounded-3 shadow-none" href="dpage2.php">2</a>
            </li>
            <li class="page-item m-1">
              <a class="page-link text-dark border-0 rounded-3 shadow-none" href="dpage3.php">3</a>
            </li>
            <li class="page-item m-1">
              <a class="page-link text-dark border-0 rounded-3 shadow-none" href="dpage2.php" aria-label="Next">
